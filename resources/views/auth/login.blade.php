			...
			<div class="row justify-content-center">
				<div class="mt-4 mb-0 text-center col-md-6">
					...
					<h2 class="heading-section">
						<span style="margin-left: 10px; font-weight: bold; font-family: 'Teko', sans-serif; color: #ffffff; font-size: 40pt">LAKON</span>
					</h2>
					<span style="margin-left: 10px; font-weight: normal; font-family: 'Teko', sans-serif; color: #ffffff; font-size: 20pt">( Layanan Konsultasi )</span>	
				</div>
			</div>
